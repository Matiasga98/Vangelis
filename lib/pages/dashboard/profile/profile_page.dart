                  ...
                  showDialog(
                    ...
                    builder: (context) {
                      return AlertDialog(
                        ...
                        content: CustomText(
                            "¿Está seguro de que desea eliminar ${_ctrl
                                .instruments.value[index]
                                .name} de su lista de instrumentos?"),
                        actions: [
                          DialogButtons(
                              onCancel: () =>
                              {
                    ...
                    builder: (context) {
                      return AlertDialog(
                        title: const Text(
                            'Eliminar genero'),
                        content: CustomText(
                            "¿Está seguro de que desea eliminar ${_ctrl.genres
                                .value[index].name} de su lista de generos?"),
                        actions: [
                          DialogButtons(
                              onCancel: () =>
                              {
                  ...
                  child: AlertDialog(
                    ...
                    content: Column(
                      children: [
                        ...
                        _ctrl.tempProfilePicture != null ?
                        CircleAvatar(
                          backgroundImage: Image.file(tempProfilePicture!).image,
                          radius: 70.0,
                        ):
                        const CircleAvatar(
                          radius: 70.0,
